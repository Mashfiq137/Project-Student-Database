...
public class Fifty_Five_JTable_Project1 extends JFrame implements ActionListener{
    ...
    private String up1,up2,up3,up4;
    /*
    ...
    */
    ...
    private void initComponent() {
        ...
        table = new JTable();
        table.setEnabled(true);  //table editable permission disable
       ...
       table.setShowGrid(true);
        ...
        copyr = new JLabel("Jahin/Rizvee/Tareq");
            ...
            public void mouseClicked(MouseEvent me) {
               int row =  table.getSelectedRow();
                ...
                String g_n = model.getValueAt(row, 3).toString();
                 up1 = model.getValueAt(row, 0).toString();
                up2 = model.getValueAt(row, 1).toString();
                 up3 = model.getValueAt(row, 2).toString();
                 up4 = model.getValueAt(row, 3).toString();
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        else if(ae.getSource() == delete)
        {
           int row_num = table.getSelectedRow();
            if (row_num >= 0) {
         int a =JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this entry?", "Permission", JOptionPane.YES_NO_OPTION);
        ...
        else if(ae.getSource() == update)
        {
           int row =  table.getSelectedRow();
                ...
                model.setValueAt(g_n, row, 3);
                  if(up1.contentEquals(f_n)&&up2.contentEquals(l_n)&&up3.contentEquals(p_n)&&up4.contentEquals(g_n)){
